...
<html>
    ...
    <body>
            ...
            <div class="container">
                ...
                <div align="right" class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto navbar-right">
                        <li class="nav-item">
                            <a class="nav-link js-scroll-trigger" href="#mexicomap">Seleccion de zona</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link js-scroll-trigger" href="#seleccionaAuto">Elegir vehiculo</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link js-scroll-trigger" href="#ingresaDatos">Ingresa datos</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div id="divAgenda" class="container">
            ...
            <label  for="span_small" class="control-label textPruebaManejo"><h2 align="center" style="color: white;">Selecciona de una zona del mapa</h2></label>
