...
<html lang="en">
    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div id="navbarResponsive" align="right" class="collapse navbar-collapse">
                    <ul class="navbar-nav ml-auto navbar-right">
                        ...
                        <li class="nav-item">
                            <a class="nav-link js-scroll-trigger navlinks" href="pruebaManejo.jsp" target="_self">Agendar prueba de manejo</a>
                        </li>
                    </ul>
                    <form action="Busqueda" method="post" class="form-inline my-2 my-lg-0">
                        <input name="name" class="form-control mr-sm-2" type="text" placeholder="Search" required>
        ...
        <section id="sectioncarousel">
            ...
            <div id="zone" class="container bg-dark" style="display: none;">
                <form method="post">
                    <div class="row">
                        <label style="color: white" class="col-form-label col"><h5>¿Desea confirmar la zona seleccionada?</h5></label>
                        <input id="selectedZone" class="form-control col" style="display: none; text-align: center; font-size: 20px" name="zone" readonly>
                        <button style="margin: auto" type="submit" class="btn btn-dark">Confirmar</button>
                    </div>
